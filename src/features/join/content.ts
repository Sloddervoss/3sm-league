...
const nl: JoinCopy = {
  ...
  hero: {
    ...
    lead: "3 Stripe Motorsport organiseert iRacing races met een eigen kalender, inschrijvingen, uitslagen, standings en teams. Deelname is gratis. Beginners en ervaren coureurs zijn welkom, solo of met een eigen team.",
    explore: "Bekijk wat er wordt gereden",
    calendar: "Naar de racekalender",
    slogan: "Hard racen. Slim racen. Respectvol racen.",
  },
  trust: [
    { title: "Gratis", detail: "Geen deelnamekosten" },
    { title: "Open instap", detail: "Geen minimum iRating" },
    { title: "Toegankelijk", detail: "Geen minimum Safety Rating" },
    { title: "Flexibel", detail: "Rijd wanneer het uitkomt" },
    { title: "Solo welkom", detail: "Een team is niet verplicht" },
    { title: "Eigen team", detail: "Neem deel onder je eigen naam" },
  ],
  live: {
    eyebrow: "Echte races, echte data",
    title: "Kijk wat er op de baan gebeurt.",
    lead: "De kalender en uitslagen laten zien wat 3SM organiseert. Geen demoresultaten en geen verzonnen activiteit.",
  ...
  why: {
    eyebrow: "Waarom 3SM",
    title: "Een community met een werkende raceomgeving.",
    lead: "3SM is meer dan een Discord en meer dan één raceteam. De community organiseert een eigen league en houdt de belangrijke race-informatie op één plek bij.",
    items: [
      ...
      { title: "Teams en solo coureurs", text: "Een eigen team is welkom, maar nooit verplicht. Individuele coureurs horen net zo goed bij de community." },
  ...
  steps: {
    ...
    items: [
      ...
      { number: "02", title: "Maak een profiel", text: "Registreer op de site en vul je iRacing gegevens volledig in." },
      { number: "03", title: "Koppel Discord", text: "Gebruik de bestaande koppel-flow zodat je siteprofiel en Discord-account bij elkaar horen." },
      { number: "04", title: "Kies een race", text: "Bekijk circuit, datum, klasse en race-informatie in de kalender." },
      { number: "05", title: "Schrijf je in", text: "Meld je aan voor een race of seizoen dat bij je planning past." },
      { number: "06", title: "Race mee", text: "Bereid je voor, rijd clean en volg daarna de uitslag en standings." },
    ],
  },
  formats: {
    eyebrow: "Klassen en langere races",
    title: "Duidelijk over wat er nu is en wat wordt gebouwd.",
  ...
  faq: {
    ...
    title: "Duidelijkheid voor de eerste race.",
    items: [
...
const en: JoinCopy = {
  ...
  hero: {
    ...
    lead: "3 Stripe Motorsport organises iRacing races with its own calendar, registrations, results, standings and teams. Participation is free. Beginners and experienced drivers are welcome, either solo or with their own team.",
    explore: "See what we race",
    calendar: "Go to the race calendar",
    slogan: "Race hard. Race smart. Race respectfully.",
  },
  trust: [
    { title: "Free", detail: "No participation fee" },
    { title: "Open entry", detail: "No minimum iRating" },
    { title: "Accessible", detail: "No minimum Safety Rating" },
    { title: "Flexible", detail: "Race when it suits you" },
    { title: "Solo welcome", detail: "A team is not required" },
    { title: "Your own team", detail: "Compete under your own name" },
  ],
  live: {
    eyebrow: "Real races, real data",
    title: "See what happens on track.",
    lead: "The calendar and results show what 3SM actually organises. No demo results and no invented activity.",
    next: "Next race",
    latest: "Latest race",
  ...
  why: {
    eyebrow: "Why 3SM",
    title: "A community with a working race platform.",
    lead: "3SM is more than a Discord and more than a single racing team. The community organises its own league and keeps the key race information in one place.",
    items: [
      ...
      { title: "Teams and solo drivers", text: "Your own team is welcome, but never required. Individual drivers are equally part of the community." },
  ...
  steps: {
    ...
    items: [
      ...
      { number: "02", title: "Create a profile", text: "Register on the site and complete your iRacing details." },
      { number: "03", title: "Link Discord", text: "Use the existing linking flow to connect your site profile and Discord account." },
      { number: "04", title: "Choose a race", text: "Check the circuit, date, class and race information in the calendar." },
      { number: "05", title: "Register", text: "Enter a race or season that fits your schedule." },
      { number: "06", title: "Race", text: "Prepare, race cleanly and follow the result and standings afterwards." },
    ],
  },
  formats: {
    eyebrow: "Classes and longer races",
    title: "Clear about what is live and what is being built.",
  ...
  faq: {
    ...
    title: "Clarity before your first race.",
    items: [
