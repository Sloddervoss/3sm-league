...
export const createEnduranceSeed = (): EnduranceState => ({
  ...
  registrations: [
    { id: "reg-jaimy", eventId, userId: "user-jaimy", status: "confirmed", classPreference: "GT3", preferredCarId: "porsche-911-gt3-r-992", slotId: "slot-1300", maxStints: 3, maxStintMinutes: null, maxTotalMinutes: null, nightDriving: true, willingToStart: true, willingToFinish: false, notes: "Kan de start nemen.", registeredAt: "2026-07-11T18:00:00.000Z" },
    { id: "reg-ricky", eventId, userId: "user-ricky", status: "confirmed", classPreference: "GT3", preferredCarId: "bmw-m4-gt3-evo", slotId: "slot-1300", maxStints: 3, maxStintMinutes: null, maxTotalMinutes: null, nightDriving: true, willingToStart: false, willingToFinish: true, notes: "Teammanager auto 31.", registeredAt: "2026-07-11T19:00:00.000Z" },
    { id: "reg-sven", eventId, userId: "user-sven", status: "confirmed", classPreference: "GT3", preferredCarId: "porsche-911-gt3-r-992", slotId: "slot-1300", maxStints: 3, maxStintMinutes: null, maxTotalMinutes: null, nightDriving: false, willingToStart: false, willingToFinish: true, notes: "Vanaf 14:30 beschikbaar.", registeredAt: "2026-07-12T10:00:00.000Z" },
    { id: "reg-milan", eventId, userId: "user-milan", status: "reserve", classPreference: "GT3", preferredCarId: "ferrari-296-gt3", slotId: "slot-1300", maxStints: 2, maxStintMinutes: null, maxTotalMinutes: null, nightDriving: true, willingToStart: true, willingToFinish: true, notes: "Stand-by als reserve.", registeredAt: "2026-07-12T12:00:00.000Z" },
  ],
  availability: [
