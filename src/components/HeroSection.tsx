      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(20rem,28rem)] lg:items-end">
          ...
          <a
            ...
            className="group relative z-20 mb-8 block overflow-hidden rounded-lg border border-[#5865F2]/30 bg-card/45 p-4 backdrop-blur-md transition-all hover:border-[#5865F2]/70 hover:bg-card/65 sm:p-5 lg:mb-0 lg:translate-y-10"
          ...
          >
            ...
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-md bg-[#5865F2] text-white shadow-lg shadow-[#5865F2]/20 sm:h-12 sm:w-12">
                <svg viewBox="0 0 245 240" aria-hidden="true" className="h-6 w-6 fill-current sm:h-7 sm:w-7">
