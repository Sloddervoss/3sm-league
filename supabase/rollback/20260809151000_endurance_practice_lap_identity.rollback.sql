...
BEGIN
  ...
  IF v_eff_event IS NOT NULL THEN
    ...
    WHERE session.event_id = v_eff_event
...
DROP INDEX IF EXISTS public.endurance_practice_laps_source_identity_uidx;
ALTER TABLE public.endurance_practice_laps
  DROP CONSTRAINT IF EXISTS endurance_practice_laps_completed_laps_check,
  DROP COLUMN IF EXISTS completed_laps,
