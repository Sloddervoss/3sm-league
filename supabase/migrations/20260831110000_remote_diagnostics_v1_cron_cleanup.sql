...
-- database (zie supabase/rollback/20260831110001_remote_diagnostics_v1_cron_setup.rollback.sql).
-- Deze migration maakt uitsluitend de functie aan; de volgende forward migration
-- beheert de cronjob.