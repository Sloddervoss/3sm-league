...
BEGIN
    ...
    INSERT INTO simhub_device_health AS h (
        ...
        (p_health->>'client_last_telemetry_attempt_utc')::timestamptz,
        (p_health->>'client_last_successful_ingest_utc')::timestamptz,
        (p_health->>'client_last_ingest_http_status')::integer,
